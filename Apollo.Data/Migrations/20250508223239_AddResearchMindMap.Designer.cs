...
namespace Apollo.Data.Migrations
{
    ...
    [Migration("20250508223239_AddResearchMindMap")]
    partial class AddResearchMindMap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apollo.Data.Models.ResearchMindMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Apollo.Data.Models.ResearchMindMap", b =>
                {
                    b.HasOne("Apollo.Data.Models.Research", "Research")
                        .WithOne("MindMap")
                        .HasForeignKey("Apollo.Data.Models.ResearchMindMap", "ResearchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
