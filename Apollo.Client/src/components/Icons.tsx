...
export function Logo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      id="Layer_1"
      viewBox="0.7 0 303 296.5"
      {...props}
    >
      <defs>
        <clipPath id="clippath">
          <path d="M.2 39h266.5v257.7H.2z" className="st0" />
        </clipPath>
        <clipPath id="clippath-1">
          <path d="M161.8 0H281v30.7H161.8z" className="st0" />
        </clipPath>
        <clipPath id="clippath-2">
          <path d="M273 0h30.7v134.6H273z" className="st0" />
        </clipPath>
        <style>{".st0{fill:none}.st3{fill:#212529}"}</style>
      </defs>
      <path
        d="M266.2 183.8h-94.9l64.1 64.1-21.2 21.2-65.4-65.4v92.8h-29.9v-91.7l-68.1 68.1-22.6-22.6 66.6-66.6H.7v-32H97L32.2 87l21.2-21.2 65.6 65.6V39.1h29.9l-.2 111.6 117.5 1.2v32Z"
        className="st3"
        style={{
      ...
      />
      <path
        d="M273 134.6V0h30.7v134.7H273Z"
        className="st3"
        style={{
      ...
      />
      <path
        d="M226.4 107.3v-949.8H78.6v987.8M226.4 115.8v-7.4"
        className="st0"
      />
    </svg>
  );
...
export function LogoLight(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      id="Layer_1"
    ...
    >
      <defs fill="#f8f9fa">
        <clipPath id="clippath-light" fill="#f8f9fa">
          <path d="M.2 39h266.5v257.7H.2z" className="st0-light" />
        </clipPath>
        <clipPath id="clippath-1-light" fill="#f8f9fa">
          <path d="M161.8 0H281v30.7H161.8z" className="st0-light" />
        </clipPath>
        <clipPath id="clippath-2-light" fill="#f8f9fa">
          <path d="M273 0h30.7v134.6H273z" className="st0-light" />
        </clipPath>
        <style>{".st0-light{fill:none}.st3-light{fill:#f8f9fa}"}</style>
      </defs>
      <path
        fill="#f8f9fa"
        d="M266.2 183.8h-94.9l64.1 64.1-21.2 21.2-65.4-65.4v92.8h-29.9v-91.7l-68.1 68.1-22.6-22.6 66.6-66.6H.7v-32H97L32.2 87l21.2-21.2 65.6 65.6V39.1h29.9l-.2 111.6 117.5 1.2v32Z"
...
export function MSWord(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      <g>
        <path
          fill="#41a5ee"
          d="M839.03 53H263.97C244.11 53 228 69.09 228 88.94v152.74L551.5 336 875 241.68V88.94C875 69.09 858.89 53 839.03 53"
        />
        ...
        <path
          fill="#103f91"
          d="M875 620H228v152.19c0 19.78 16.11 35.81 35.97 35.81h575.06c19.86 0 35.97-16.03 35.97-35.81V620"
        />
        <path
          fillOpacity=".1"
          d="M461.14 188H228v512h233.14c19.78-.06 35.8-16.12 35.86-35.94V223.94c-.06-19.82-16.08-35.88-35.86-35.94"
        />
        <path
          fillOpacity=".2"
          d="M434.16 215H228v512h206.14c19.78-.05 35.8-16.11 35.86-35.94V250.94c-.06-19.83-16.08-35.89-35.86-35.94h.02"
        />
        <path
          fillOpacity=".2"
          d="M434.16 215H228v458h206.14c19.77-.05 35.78-16.09 35.86-35.91V250.91c-.08-19.82-16.09-35.86-35.86-35.91h.02"
        />
        <path
          fillOpacity=".2"
          d="M407.16 215H228v458h179.16c19.76-.06 35.76-16.1 35.84-35.91V250.91c-.08-19.81-16.08-35.85-35.84-35.91"
        />
        <path
          fill="#185abd"
          d="M48.9 215h359.2c19.83 0 35.9 16.07 35.9 35.9v359.2c0 19.83-16.07 35.9-35.9 35.9H48.9C29.07 646 13 629.93 13 610.1V250.9c0-19.83 16.07-35.9 35.9-35.9"
        />
        <path
          fill="#fff"
          d="M335.04 565H286.5l-56.65-185.61L170.5 565h-48.54L68 296h48.57l37.75 188.3 56.65-182.92h40.45l53.96 182.92L343.13 296H389l-53.96 269"
        />
      </g>
    </svg>
  );
...
export function MSPowerPoint(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      viewBox="-0.5 -0.5 889 864"
