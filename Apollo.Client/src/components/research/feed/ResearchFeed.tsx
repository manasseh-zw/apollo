...
export default function ResearchFeed({
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      addToast({
        description:
          "This might take a bit (~15-30 min). Feel free to do your thing – i'll email you when it's ready, or you can watch us work.",
        hideIcon: false,
        classNames: {
          base: "font-rubik",
          icon: "w-8 h-8",
        ...
        icon: (
          <Avatar
            ...
            fallback={<div className="rounded-full bg-primary" />}
          />
        ),
      });
    }, 120000);
