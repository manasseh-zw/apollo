...
export default function ChatLandingPromptForm({
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 rounded-3xl animate-pulse-slow bg-gradient-to-r from-purple-500 via-pink-500 to-violet-500 blur-md opacity-20"></div>

      <form
        className="relative flex w-full flex-col items-start bg-white rounded-3xl shadow-[0_2px_4px_0_rgba(0,0,0,0.08)] border border-transparent overflow-hidden z-10"
